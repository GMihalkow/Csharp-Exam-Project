...
namespace Forum.Web.Areas.AccountPanel.Services.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        public SettingsService(IMapper mapper, IDbService dbService, IReplyService replyService, SignInManager<ForumUser> signInManager, IQuoteService quoteService, IReportService reportService, IMessageService messageService, UserManager<ForumUser> userManager, Web.Services.Account.Contracts.IAccountService accountService)
        {
            this.mapper = mapper;
        ...
        public bool EditProfile(ForumUser user, EditProfileInputModel model)
        {
